...
public class ChatClient {
    // Messages / Server calls
    private final static String HELP_SERVER = "HELP_SERVER";
    private final static String LOGOUT = "LOGOUT";
    private final static String LOGOUT_ROOM = "LOGOUT_ROOM";
    private final static String LIST_CHATROOMS = "CHATROOMS";
    private final static String LIST_USERS = "USERS";
    private final static String CREATE_CHATROOM = "CREATE";
    private final static String JOIN = "JOIN";
    public final static String IN_CHATROOM = "IN_CHATROOM";
    public final static String USERS_IN_CHATROOM = "USERS_CHAT";
    // for I/O
        ...
        public void run() {
            while(running) {
                try {
                    ...
                    if (msg.equals(ChatServer.SERVER_CALL)){
                        serverCall = true;
                        continue;
                    } else if(serverCall){
